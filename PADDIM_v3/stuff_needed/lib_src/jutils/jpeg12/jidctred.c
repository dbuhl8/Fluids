...
GLOBAL(void)
joep_idct_4x4 (j_decompress_ptr cinfo, joep_component_info * compptr,
	       JCOEFPTR coef_block,
...
GLOBAL(void)
joep_idct_2x2 (j_decompress_ptr cinfo, joep_component_info * compptr,
	       JCOEFPTR coef_block,
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  INT32 tmp0, tmp10, z1;
...
GLOBAL(void)
joep_idct_1x1 (j_decompress_ptr cinfo, joep_component_info * compptr,
	       JCOEFPTR coef_block,
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  int dcval;
