...
int icddwrite_(iu,niter,time,dt,x,xlen)
...
int icddwrite(long iu, long *niter,double *time,double *dt,double *x,long *xlen)
{
  return(icddwrite_(&iu,niter,time,dt,x,xlen));
}
